...
class RestrictiveParameterChecker implements ParameterCheckerInterface
{
     ...
     * @param bool                      $allowExtensionsSupport If JSON API extensions support is allowed.
     */
    public function __construct(
        ...
        $this->allowExtensionsSupport = $allowExtensionsSupport;
    }
    ...
    protected function checkAcceptHeader(ParametersInterface $parameters)
    {
        ...
        if ($inputMediaType === null || (
                ...
                $inputMediaType->getMediaType() === MediaTypeInterface::JSON_API_MEDIA_TYPE &&
                ($typeParams = $inputMediaType->getParameters()) !== null &&
                array_key_exists(MediaTypeInterface::PARAM_EXT, $typeParams) === true)
        ) {
